...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Bem-vindo à Sweet Haven Confeitaria, onde cada doce é feito com
                carinho e dedicação por Manu Techio. Criamos brigadeiros, trufas
                e sobremesas artesanais que encantam o paladar e aquecem o
                coração.
              </p>
              <Link
                href="/contato"
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p
              ...
              style={{ fontFamily: "'Quicksand', sans-serif" }}
            >
              Cada doce é uma obra de arte feita com ingredientes selecionados e
              muito amor.
            </p>
          </motion.div>
      ...
      {/* SOBRE A MANU */}
      <section className="bg-[#FFF7F3] py-24">
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-12 px-6">
          ...
          <div>
            <h2
              ...
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
              Feito com amor por Manu Techio 💖
            </h2>
            <p
              className="text-lg leading-relaxed text-gray-700"
              style={{ fontFamily: "'Quicksand', sans-serif" }}
            >
              Cada doce da Sweet Haven é feito à mão, com ingredientes
              selecionados e aquele toque artesanal que transforma momentos
              simples em lembranças doces.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* CTA FINAL */}
      <section className="py-20 bg-[#5C3A21] text-white text-center">
        <div className="container mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
